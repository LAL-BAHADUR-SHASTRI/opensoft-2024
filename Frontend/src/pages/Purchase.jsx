                ...
                <div className="relative grid h-[25rem] flex-col items-end justify-center overflow-hidden bg-white bg-clip-border text-center text-gray-700">
                  ...
                  <div className="flex">
                    <img
                      alt="logo"
                      src="logo.png"
                      className="relative inline-block object-center w-80 h-40"
                    />
                    <div className="relative p-6 px-6 py-14 md:px-12">
                      <h2 className="mb-6 block font-sans text-4xl font-medium leading-[1.5] tracking-normal text-white antialiased">
                        Upgrade your <span className="text-gold">viewing </span>
                        experience
                      </h2>
                      <h5 className="block mb-4 font-sans text-xl antialiased leading-snug tracking-normal text-gray-400">
